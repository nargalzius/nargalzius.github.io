/*
	...
	DOCS: nargalzius.github.io/ajax/joystick/dom_loader
*/
...
var dom = {
	...
	init : function(obj) {
		...
		this.content.parent().show().css('opacity','1');
	},
	preloader : function(img_array) {

		spinner = new Spinner(dom.spinConfig).spin(document.getElementById($(dom.content.parent()).attr('id').toString()));
